...
function kbe_articles() {
	...
	/**
	 * Filter the arguments for the 'kbe_knowledgebase' post type
	 *
	 * @param array  $args
	 * @param string $post_type
	 *
	 */
	$args = apply_filters( 'kbe_register_post_type_args', $args, 'kbe_knowledgebase' );
...
function kbe_taxonomies() {
	...
	$args = array(
		...
		'show_in_rest'      => true,
		'query_var'         => true,
		'rewrite'           => array( 'slug' => KBE_CATEGORY_SLUG, 'with_front' => true )
	);

	/**
	 * Filter the arguments for the 'kbe_taxonomy' taxonomy
	 *
	 * @param array  $args
	 * @param string $taxonomy
	 *
	 */
	$args = apply_filters( 'kbe_register_taxonomy_args', $args, 'kbe_taxonomy' );
...
function kbe_custom_tags() {
	...
	/**
	 * Filter the arguments for the 'kbe_tags' taxonomy
	 *
	 * @param array  $args
	 * @param string $taxonomy
	 *
	 */
	$args = apply_filters( 'kbe_register_taxonomy_args', $args, 'kbe_tags' );

	// Register the "tags" taxonomy
	register_taxonomy( 'kbe_tags', 'kbe_knowledgebase', $args );
