...
add_action('widgets_init', 'foodfarm_fatest_tweet_widget');
function foodfarm_fatest_tweet_widget(){
    register_widget('FoodfarmLatestTweetWidget');
}
class FoodfarmLatestTweetWidget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'foodfarm_latest_tweet', // Base ID
                __('Foodfarm Latest Tweet', 'foodfarm'), // Name
                array('description' => __('This Widget show the Latest Tweets', 'foodfarm'),) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        $tweets = new FoodfarmLatestTweet();
    ...
    public function form($instance) {
        $title = !empty($instance['title']) ? $instance['title'] : __('New title', 'foodfarm');
        ?>
        <p>
