                    ...
                    <ul class="knowledge-list-wrap">
                        ...
                        <?php if ($kbe_tax_post_qry->have_posts()): ?>
                            <?php while ($kbe_tax_post_qry->have_posts()) : $kbe_tax_post_qry->the_post(); ?>
                                <?php $portfolio_related = get_post_meta(get_the_ID(), 'related_entries', true); ?>
                                <li class="blog-content recipes-list-container">
                                    <div class="blog-item">
                                        ...
                                        <?php if (is_array($portfolio_related)) : ?>
                                            <?php if (count($portfolio_related) > 0) : ?>
                                                <div class="knowledge-list-content">
                                                    <ul>
                                                        <?php foreach ($portfolio_related as $key => $entry) : ?>
                                                            <?php
                                                            $post_term_arr = wp_get_post_terms($entry);
                                                            $post_term_names = '';
                                                            ?>
                                                            <li>
                                                                <a href="<?php echo esc_url(get_permalink($entry)); ?>"><?php echo get_the_title($entry); ?></a>
                                                            </li>
                                                        <?php endforeach; ?>   
                                                    </ul>
                                                </div>
