(function ($) {
    ...
    jQuery(document).ready(function($){
        $('.color-picker-meta').iris();
    });
    jQuery(document).ready(function($) {
        // color field
        $('.ff-meta-color').each(function() {
            var $el = $(this),
                $c = $el.find('.ff-color-field'),
                $t = $el.find('.ff-color-transparency');
    ...
    $('#redux-header').remove();
    $('<div class="redux-header"><div class="display_header"><h2>Foodfarm Options</h2><span>'+foodfarm_params.foodfarm_version+'</span></div><div class="clear"></div></div>').insertBefore('.redux-container .redux-sidebar');
})(jQuery);
