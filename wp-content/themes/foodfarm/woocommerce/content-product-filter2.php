...
$classes[] = "item col-lg-3 col-md-4 col-sm-6 col-xs-12 ";
$classes[] = $post_term_filters;
?>

<div <?php post_class($classes) ?>>
    <div class="product-content">
        <a href="<?php the_permalink(); ?>" class="hover_overlay"></a>
        <div class="product-img">
                <?php
                /**
                 * woocommerce_before_shop_loop_item_title_type2 hook
                 *
                 * @hooked woocommerce_show_product_loop_sale_flash - 10
                 * @hooked woocommerce_template_loop_product_thumbnail - 10
                 */
                do_action('woocommerce_before_shop_loop_item_title_type2');
                ?>
        </div>
        <div class="product-desc">  
	        <div class="product-action">
	                ...
	                do_action('woocommerce_shop_loop_item_title_type2');
	                ?>
	        </div>  
