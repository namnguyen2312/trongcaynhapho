...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row form-row-first">
		...
		<input type="text" class="input-text" name="username" placeholder="<?php echo esc_attr__( 'Username or email', 'foodfarm' ); ?>" id="username" />
	</p>
	<p class="form-row form-row-last">
		<input class="input-text" type="password" name="password" placeholder="<?php echo esc_attr__( 'Password', 'foodfarm' ); ?>" id="password" />
	</p>
	<div class="clear"></div>
